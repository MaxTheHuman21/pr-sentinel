...
from middleware.auth_middleware import auth_middleware  # ← Importamos el middleware real
...
@auth_middleware  # 🟢 SEGURIDAD EN ORDEN: Ponemos el decorador de vuelta. (Desaparece el error ADR-002)
def get_orders():
    try:
        ...
        # 🚨 VIOLACIÓN CRÍTICA DE ADR-003:
        # Dejamos rota la respuesta de error. En lugar de retornar el objeto JSON estandarizado
        # con "success": False, disparamos un string plano que quiebra la unificación del backend.
